...
import { setUser , addCategoryList } from '../services/actions/index'
...
class Lists extends Component {
  ...
  navTo=(todoId)=>{
    const { navigation } = this.props
    navigation.navigate('TodoList',{id:todoId})
  }
...
addNewList=()=>{
this.props.addCategoryList(this.state.textInput)
this.setState({textInput:''})
}
      ...
      <View style={styles.container} >
        <Animated.View style={styles.flatlistWrapper} >
          ...
          <FlatList
            ...
            ListFooterComponent={this.renderFooter(this.props.todoLists.length)}
          ...
          onContentSizeChange={() => this.flatList.scrollToEnd({ animated: true })}
            ...
            <TouchableHighlight onPress={()=>this.navTo(item.id)} style={styles.listElement} >
...
export default connect(mapStateToProps, { setUser  , addCategoryList })(Lists)
